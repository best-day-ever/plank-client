macx {
    ...
    OBJECTIVE_SOURCES += test_metalpresentation.mm ../../app/streaming/video/ffmpeg-renderers/vt_base.mm
    ...
    error("This GPU probe requires a macOS desktop and Metal")
}
